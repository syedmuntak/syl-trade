        ...
        <div class="element-wrapper">
            ...
            <div class="element-box-tp">
                <div class="controls-above-table">
                    <div class="row">
                        <div class="col-sm-6">
                            <a class="btn btn-sm btn-secondary" href="{{ route('admin.division.create') }}">Add New </a>
                            ...
                            @foreach ($divisions as $key => $item)
                                <tr>
                                    ...
                                    <td class="row-actions">
                                        <a href="{{ route('admin.division.edit',['id' => $item->id, 'slug' => $item->slug]) }}">
                                            <i class="os-icon os-icon-ui-49"></i>
                                        </a>
                                        <a href="#">
                                            <i class="os-icon os-icon-grid-10"></i>
                                        </a>
                                        <a class="danger" onclick="return confirm('Are you sure to delete?')" href="{{ route('admin.division.destroy', $item->id) }}">
