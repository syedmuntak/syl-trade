...
<div class="row">
    <div class="col-sm-12">
        <div class="element-wrapper">
            <h6 class="element-header">Genders</h6>
            <div class="element-box-tp">
                <div class="controls-above-table">
                    <div class="row">
                        <div class="col-sm-6">
                            <a class="btn btn-sm btn-secondary" href="{{ route('admin.gender.create') }}">Add New </a>
                            ...
                            @foreach ($genders as $key => $item)
                                <tr>
                                    ...
                                    <td class="row-actions">
                                        <a href="{{ route('admin.gender.edit',['id' => $item->id, 'slug' => $item->slug]) }}">
